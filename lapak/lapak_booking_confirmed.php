        ...
        <div class="panel-heading" style="background:#026466;">
          ...
          <div class="table-responsive">
            <table class="table table-hover">
              ...
              <tbody>
                <?php
                  $query = "SELECT * FROM tbl_booking INNER JOIN tbl_indekos ON (tbl_booking.id_indekos=tbl_indekos.id_indekos) WHERE tbl_booking.id_penjual={$getID} AND tbl_booking.status_booking='CONFIRMED'";       
                  $records_per_page=10;
