...
<div class="container">
  <div class="row">
    <ol class="breadcrumb">
      ...
      <li class="active">Edit Indekos</li>
    </ol>
    <div class="col-md-12">
        ...
        <div class="panel-heading" style="background:#026466;">
          ...
          <form method="post" enctype="multipart/form-data" style="padding-top:10px;">
            <div class="form-group col-md-12">
              <small>Judul</small>
              <input type="text" class="form-control" value="<?php echo $judul ?>" name="judul" required>
            </div>
            ...
            <div class="form-group col-md-4">
              ...
              <input type="number" class="form-control" value="<?php echo $harga ?>" name="harga" required>
            </div>
