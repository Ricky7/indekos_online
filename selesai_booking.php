...
<div class="cart_main">
	 <div class="container">
			 <ol class="breadcrumb">
			  ...
			  <li class="active">Selesai Booking</li>
			 </ol>			
	            ...
	            <table class="table table-hover">
	              ...
	              <tbody>
	                <?php
	                  ...
	                  WHERE (tbl_booking.id_pembeli, tbl_booking.status_booking) IN (({$datas['id_user']}, 'PROCESS'), ({$datas['id_user']}, 'PAYING'), ({$datas['id_user']}, 'COMPLETED')) 
