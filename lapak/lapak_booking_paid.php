...
<div class="container">
  <div class="row">
    <ol class="breadcrumb">
      <li class="active">Segera Konfirmasi</li>
    ...
    <div class="col-md-12">
      <div class="panel panel">
        <div class="panel-heading" style="background:#026466;">
          <h3 class="panel-title" style="color:#fff;">Segera Konfirmasi</h3>
        </div>
          ...
          <div class="table-responsive">
            <table class="table table-hover">
              ...
              <tbody>
                <?php
                  $query = "SELECT * FROM tbl_booking INNER JOIN tbl_indekos ON (tbl_booking.id_indekos=tbl_indekos.id_indekos) WHERE tbl_booking.id_penjual={$getID} AND tbl_booking.status_booking='PAID'";       
                  $records_per_page=10;
